...
public class PasswordField extends JPasswordField {
    ...
    private static final long serialVersionUID = -8751766978341567383L;
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon("image/eye.png").getImage();
        eye_hide = new ImageIcon("image/eye_hide.png").getImage();
