...
public class TableScrollButton extends JLayeredPane {
    ...
    private static final long serialVersionUID = -7639998042607137741L;
    ...
    private class ScrollLayerUI extends LayerUI<JScrollPane> {
        ...
        private static final long serialVersionUID = 2291674151512128814L;
		private Shape shape;
        @SuppressWarnings("unused")
		private Color color = new Color(60, 148, 225);
        private boolean mousePressed;
        private boolean mouseHovered;
        private final Image image = new ImageIcon(getClass().getResource("")).getImage();
